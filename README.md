...
Lightweight node module for data encryption and decryption using lightweight encryption algorithm ROMULUS-H. This is Java adaptation of [ROMULUS-H C implementation](https://github.com/romulusae/romulus).
